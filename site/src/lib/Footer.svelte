...
<div class="footer">
    ...
    <div class="footer-row">
        <a href="https://discord.gg/EZWxGRv4Eh" class="footer-link" target="_blank">
            <svg class="footer-link-image" width="71" height="55" viewBox="0 0 71 55" xmlns="http://www.w3.org/2000/svg">
...
<style lang="scss" global>
    ...
    path {
        fill: $accent-text-color-light;
        @media (prefers-color-scheme: dark) {
            fill: $accent-text-color-dark;
        }
    }
    .dropdown {
        position: relative;
